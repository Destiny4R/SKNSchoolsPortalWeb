...
namespace SKNSchoolsPortal.Controllers
{
    ...
    public class apiController : Controller
    {
        ...
        public apiController(SignInManager<ApplicationUser> signInManager, ApplicationDbContext dbContext, ILogger<apiController> logger)
        {
